class Movie {
  ...
  Movie({ required this.MovieName,  required this.MoviePoster,  required this.MovieDescription,  this.ReleaseYear,  this.Director,  this.Cast,  this.Category,  this.Views});
